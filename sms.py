...
def connect_database():
    def connect():
        global mycursor,con
        try:
            con=pymysql.connect(host='localhost',user='root',password='Nvd@2002')
            mycursor=con.cursor()
        except:
...
connectButton=Button(root,text='Connect database',bg='grey',fg='black',font=('arial',13,'bold'),command=connect_database)
...
addstudentButton=Button(leftFrame,text='Add Student',bg='grey',fg='black',font=('arial',10,'bold'),width=25,state=DISABLED,command=lambda :toplevel_data('Add Student','Add',add_data))
addstudentButton.grid(row=1,column=0,pady=20)

searchstudentButton=Button(leftFrame,text='Search Student',bg='grey',font=('arial',10,'bold'),fg='black',width=25,state=DISABLED,command=lambda :toplevel_data('Search Student','Search',search_data))
searchstudentButton.grid(row=2,column=0,pady=20)

deletestudentButton=Button(leftFrame,text='Delete Student',bg='grey',font=('arial',10,'bold'),fg='black',width=25,state=DISABLED,command=delete_student)
deletestudentButton.grid(row=3,column=0,pady=20)

updatestudentButton=Button(leftFrame,text='Update Student',bg='grey',font=('arial',10,'bold'),fg='black',width=25,state=DISABLED,command=lambda :toplevel_data('Update Student','Update',update_data))
updatestudentButton.grid(row=4,column=0,pady=20)

showstudentButton=Button(leftFrame,text='Show Student',bg='grey',font=('arial',10,'bold'),fg='black',width=25,state=DISABLED,command=show_student)
showstudentButton.grid(row=5,column=0,pady=20)

exportstudentButton=Button(leftFrame,text='Export data',bg='grey',font=('arial',10,'bold'),fg='black',width=25,state=DISABLED,command=export_data)
exportstudentButton.grid(row=6,column=0,pady=20)

exitButton=Button(leftFrame,text='Exit',bg='grey',font=('arial',10,'bold'),fg='black',width=25,command=iexit)
